        ...
        <div class="card-body">
            <form action="{{ route('admin.empleados.update', $empleado->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="empleado[direccion]" class="form-control" value="{{ old('empleado.direccion', $empleado->direccion) }}">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="persona[carnet]" class="form-control" value="{{ old('persona.carnet', $empleado->persona->carnet) }}">
                </div>

                <div class="mb-3">
                    <label for="nombre" class="form-label">Nombre</label>
                    <input type="text" name="persona[nombre]" class="form-control" value="{{ old('persona.nombre', $empleado->persona->nombre) }}">
                </div>

                <div class="mb-3">
                    <label for="telefono" class="form-label">Teléfono</label>
                    <input type="text" name="persona[telefono]" class="form-control" value="{{ old('persona.telefono', $empleado->persona->telefono) }}">
                </div>
        ...
        <div class="card-body">
            <form action="{{ route('admin.empleados.update', $empleado->id) }}" method="POST">
                ...
                <div class="text-center mt-4">
                    ...
                    <a href="{{ route('admin.empleados.index') }}" class="btn btn-secondary btn-lg">
